...
```
You can also use Laravels [implicit route model binding](https://laravel.com/docs/8.x/routing#implicit-binding) inside your controller to automatically resolve the model. To use the feature make sure that the slug column matches the `routeNameKey`.  
